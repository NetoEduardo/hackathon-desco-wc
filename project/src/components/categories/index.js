  ...
  return(
    <div id={id} className={className} >
        <Slider className='slider-categorias' {...settings}>
          <div className='item'>
            <h2>Vestibulares</h2>
            <h3 className='h3-slider'>Temos 3 planos perfeitos para você mandar bem em todos os vestibulares do país e Enem.</h3>
          ...
          <div className='item'>
            ...
            <h3 className='h3-slider'>Cursos de reforço escolar para Ensino Médio e preparatório para o Encceja.</h3>
          ...
          <div className='item'>
            ...
            <h3 className='h3-slider'>Reforços para os cursos de Medicina, Direito e Engenharia.</h3>
          ...
          <div className='item'>
            <h2>Concursos</h2>
            <h3 className='h3-slider'>Estude para carreiras Jurídicas, Policiais, Analistas, Técnicas e Iniciantes</h3>
          ...
          <div className='item'>
            <h2>Pós-Graduação</h2>
            <h3 className='h3-slider'>Pós e MBA em Gestão, Educação, Direito e Tecnologia.</h3>
          ...
          <div className='item'>
            <h2>OAB</h2>
            <h3 className='h3-slider'>Curso preparatório para o exame da Ordem dos Advogados do Brasil.</h3>
